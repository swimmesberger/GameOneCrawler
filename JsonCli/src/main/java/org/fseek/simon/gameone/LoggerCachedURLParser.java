...
public class LoggerCachedURLParser extends CachedURLParser {
    private static final Logger logger = LoggerFactory.getLogger(LoggerCachedURLParser.class);

    public LoggerCachedURLParser(URLParser delegate) {
        super(delegate);
    }

    public LoggerCachedURLParser(URLParser delegate, Path cacheDir) {
